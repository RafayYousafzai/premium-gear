    ...
    return (
        <div className="popup-overlay">
            <div className="popup-container">
                ...
                <p className="reservation-price">Reservation Price: €{vehicle.reservationPrice}</p>
                <p className="notification-text">
                    An email will be sent to you with the booking details along with the bank details to make the due amount, 
                    which is the reservation price. Please make sure all the information is correct.
                </p>
                {loading ? (
                    <div className="preloader">Processing your reservation...</div>
                ) : (
                    <>
                        <button className="confirm-button" onClick={handleConfirmClick}>Yes, Confirm</button>
