      ...
      <div className="checkout-container">
          ...
          {isAuthenticated ? (
            ...
            <div>
              <div className="auth-header">
                ...
                <p>
                  Please enter your email and log in to your account. From your
                  account you can place your order, manage your purchase and
                  follow all the updates in a safe and transparent way.
                </p>
              </div>
        ...
        <div className="vehicle-summary">
          ...
          <p className="total-price">
            <strong>Total Price:</strong> €{vehicle.price}
          </p>
          <p className="reservation-price">
            <strong>Reservation Price:</strong> €{vehicle.reservationPrice}
          </p>
          {showOverview && (
            <button
